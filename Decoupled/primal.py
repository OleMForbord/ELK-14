...
def print_primal(Pactual,Qactual,Pindex, Qindex, tindex, vindex, v, teta, g, b,z):
    ...
    correction_teta = h_inv.dot(missmat_p(Pactual, Pindex, v, teta, g, b))
    correction_v = leq_inv.dot(missmat_q(Qactual, Qindex, v, teta, g, b))
    ...
    while np.any(abs(correction_teta)  > epsilonError):
        ...
        correction_v = leq_inv.dot(missmat_q(Qactual, Pindex, v, teta, g, b))
